...
$id_permiso = isset($_POST["tipo_usuario"])? limpiarCadena($_POST["tipo_usuario"]):"";
switch ($_GET["op"]){
    case 'guardaryeditar':
        ...
        if(empty($id_usuario))
        {
            ...
            if($cantidad2 == 0){
                if(strlen($clave_us)<8){
                    echo $rspta2 ? "La clave debe tener al menos 8 caracteres" : "La clave debe tener al menos 8 caracteres";
                        ...
                        if($cantidadced == 0){
                            $rspta= $empleados->insertar($cedula_usuario,$nombre_usuario,$apellido_usuario,$telefono_usuario,$direccion_usuario,$email_usuario,$login_us,$clavehash, $imagen_usuario,$id_permiso);
            ...
            if($cantidad3 == 1)
            {
                    ...
                    {
                        $rspta= $empleados->editar($id_usuario,$cedula_usuario,$nombre_usuario,$apellido_usuario,$telefono_usuario,$direccion_usuario,$email_usuario,$login_us,$clave_us, $imagen_usuario,$id_permiso);
                        echo $rspta ? "Usuario actualizado" : "No se pudo actualizar el usuario";
                 }else{
                     $rspta= $empleados->editar($id_usuario,$cedula_usuario,$nombre_usuario,$apellido_usuario,$telefono_usuario,$direccion_usuario,$email_usuario,$login_us,$clavehash, $imagen_usuario,$id_permiso);
                 echo $rspta ? "Usuario actualizado" : "No se pudo actualizar el usuario";
                 }
