...
Class Usuario
{
	...
	public function insertar($cedula_usuario,$nombre_usuario,$apellido_usuario,$telefono_usuario,$direccion_usuario,$email_usuario,$login_us,$clave_us,$imagen_usuario,$id_permiso)
	{
		$sql="INSERT INTO usuarios (cedula_usuario,nombre_usuario,apellido_usuario,telefono_usuario,direccion_usuario,email_usuario,login_us,clave_us,imagen_usuario,estado_usuario,tipo_usuario)
		 VALUES ('$cedula_usuario','$nombre_usuario','$apellido_usuario','$telefono_usuario','$direccion_usuario','$email_usuario','$login_us','$clave_us','$imagen_usuario','1','$id_permiso')";
         //('$cedula_usuario','$nombre_usuario','$apellido_usuario','$telefono_usuario','$direccion_usuario','$email_usuario','$login_us','$clave_us','$imagen_usuario','1')";
	...
	public function editar($id_usuario,$cedula_usuario,$nombre_usuario,$apellido_usuario,$telefono_usuario,$direccion_usuario,$email_usuario,$login_us,$clave_us,$imagen_usuario,$id_permiso)
	{
		...
		login_us='$login_us',clave_us='$clave_us',imagen_usuario='$imagen_usuario',tipo_usuario='$id_permiso' WHERE id_usuario='$id_usuario'";
		return ejecutarConsulta($sql);
	...
	public function listar()
	{
		...
		$sql="SELECT  u.*,p.*,up.*   FROM usuarios u, permisos p, usuario_permisos up where u.id_usuario = up.id_usuario and p.id_permiso = up.id_permiso";
		return ejecutarConsulta($sql);		
	}
    ...
    {
    	$sql="SELECT * FROM usuarios WHERE login_us='$login_us' AND clave_us='$clave_us' and estado_usuario = '1'"; 
    	return ejecutarConsulta($sql);  
    }
