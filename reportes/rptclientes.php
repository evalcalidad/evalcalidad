...
$pdf->Cell(21,6,utf8_decode('F/N'),1,0,'C',1);
$pdf->Cell(16,6,utf8_decode('Usuario'),1,0,'C',1);
$pdf->Cell(24,6,utf8_decode('Rol'),1,0,'C',1);
...
$rspta = $clientes->listar2();

//Table with rows and columns
$pdf->SetWidths(array(23,21,22,21,21,21,21,16,24));
...
{  
  ...
  $fecha_nac_usuario = $reg->fecha_nac_usuario;
  $login = $reg->login_us;
  $tipo_usuario =$reg->tipo_usuario;
 	
 	$pdf->SetFont('Arial','',10);
   $pdf->Row(array(utf8_decode($cedula_usuario),utf8_decode($nombre_usuario),utf8_decode($apellido_usuario),utf8_decode($telefono_usuario),utf8_decode($direccion_usuario),utf8_decode($email_usuario),utf8_decode($fecha_nac_usuario),utf8_decode($login),utf8_decode($tipo_usuario)));
}
