...
require_once "../modelos/Estudiosprosp.php";
$hc = new Estudiosprosp();
...
$pdf->SetFont('Arial','B',10);
$pdf->Ln(12); 
$pdf->Cell(190,6,utf8_decode('Indicador: Estudios prospectivos y planificación'),1,0,'J',1);
$pdf->Ln(6); 
$pdf->SetFont('Arial','',10);
$pdf->Multicell(190,6,utf8_decode("La unidad académica que integra la carrera dispone de una planificación que establece objetivos y propósitos coherentes con la misión y visión de la carrera, con el marco institucional y con estudios del estado actual y su prospectiva; además el proceso de planificaciónconsidera la participación de actores relevantes de la comunidad académica y de la institución para su construcción y la evaluación de los resultados esperados."),1,'J',1); # FJ es el Force Justify
$pdf->Ln(50);
$pdf->SetFillColor(255,255,255); 
$pdf->SetFont('Arial','B',10);
