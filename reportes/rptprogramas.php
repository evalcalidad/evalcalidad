...
$pdf->SetFont('Arial','B',10);
$pdf->Ln(12); 
$pdf->Cell(190,6,utf8_decode('Subcriterio: Vinculación con la sociedad'),1,0,'J',1);
$pdf->Ln(6); 
$pdf->SetFont('Arial','',10);
$pdf->Multicell(190,6,utf8_decode("Este subcriterio se enfoca en los resultados de la carrera relacionados con la vinculación con la sociedad, a través del estándar de proyectos de vinculación con la sociedad."),1,'J',1); # FJ es el Force Justify
$pdf->SetFont('Arial','B',10);
$pdf->Ln(12); 
$pdf->Cell(190,6,utf8_decode('Indicador: Programas/Proyectos de vinculación con la sociedad'),1,0,'J',1);
$pdf->Ln(6); 
$pdf->SetFont('Arial','',10);
$pdf->Multicell(190,6,utf8_decode("La carrera participa en los programas y proyectos institucionales de vinculación con la sociedad relacionados con sus dominios académicos de manera coherente con su misión, visión, objetivos, estrategias y resultados esperados en la docencia e investigación."),1,'J',1); # FJ es el Force Justify
$pdf->Ln(70);
$pdf->SetFillColor(255,255,255); 
$pdf->SetFont('Arial','B',10);
...
{  
    ...
    $valor_ind = $reg->valor_ind;
 	...
 	$pdf->SetFont('Arial','',10);
  $pdf->Row(array(utf8_decode($preg), utf8_decode($num_cumpli), utf8_decode($cumplimiento), utf8_decode($valoracion), utf8_decode($observacion)));
}
