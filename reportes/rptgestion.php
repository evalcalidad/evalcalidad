...
$pdf->SetFont('Arial','B',10);
$pdf->Ln(12); 
$pdf->Cell(190,6,utf8_decode('Indicador: Gestión del aseguramiento interno de la calidad'),1,0,'J',1);
$pdf->Ln(6); 
$pdf->SetFont('Arial','',10);
$pdf->Multicell(190,6,utf8_decode("La gestión del aseguramiento interno de la calidad en la carrera está enfocada en el logro de los resultados de aprendizaje esperados para los estudiantes, es coherente con las políticas institucionales de aseguramiento de la calidad y es un insumo fundamental para garantizar la mejora continua a través de mecanismos como la autoevaluación."),1,'J',1); # FJ es el Force Justify
$pdf->Ln(50);
$pdf->SetFillColor(255,255,255); 
$pdf->SetFont('Arial','B',10);
