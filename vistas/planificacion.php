            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <center><h1 class="box-title">PLANIFICACIÓN: MISIÓN Y VISIÓN</h1></center>
                    ...
                    <label align="justify"><i><font size="2" name="crit" id="crit"><!-- La pertinencia es uno de los principios que rigen el Sistema de Educación Superior, establecido en la Ley Orgánica de Educación Superior (LOES, 2010) el criterio se refiere a las capacidades que tiene una carrera para responder y articularse a las demandas del entorno como criterio considera estándares sobre la relación dialéctica de la educación superior, en su oferta de grado, con su contexto. 
                    Respecto al principio de Pertinencia es fundamental que la oferta de grado considere la planificación nacional y la política pública en educación superior, así también la normativa relacionada. En particular, para la revisión de pertinencia de carreras, estos estándares consideran las características académicas de programa que respondan a los requerimientos del entorno, particularmente que contribuyan a la planificación nacional para el desarrollo y la reducción de brechas en sectores prioritarios y emergentes. -->						
                    </font></i></label>
                    <label><b><font size="2">Subcriterio: Planificación</font></b></label><br>
                    <label align="justify"><i><font size="2" name="subcrit" id="subcrit">
                    </font></i></label>
                    <label><b><font size="2">Indicador: Misión y visión</font></b></label><br>
                    <label  align="justify"><i><font size="2"  name="indicador" id="indicador">			
                      </font></i></label><br>
                      <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <label>Docente responsable del criterio</label>
                        <select id="id_dato" name="id_dato" onchange="datos()" class="form-control selectpicker" data-live-search="true" required></select>
                          </div>
                      <div class="form-group col-lg-2 col-md-4 col-sm-4 col-xs-4">
                        <label>Valor de indicador: Misión y visión</label>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-2">
                          ...
                          <label id="preg" name="preg" align="justify"></label> 
                            <input type="hidden" name="id_ev_p" id="id_ev_p">
