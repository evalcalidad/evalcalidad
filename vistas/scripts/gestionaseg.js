...
function init(){
	...
	$.post("../ajax/gestionaseg.php?op=selecttema", function(r){ //parametro r son las opciones que devuelve el id
     $("#id_dato").html(r);
...
function reporte(){
    ...
    $url = '../reportes/rptgestion.php?id=' + id_dato;
    target = "_blank";
...
function datos(){
	...
	$.post("../ajax/gestionaseg.php?op=datos",{id_dato : id_dato}, function(r){ //parametro r son las opciones que devuelve el id
		r = JSON.parse(r);
...
function listar()
{
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/gestionaseg.php?op=listar',
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../ajax/gestionaseg.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function mostrar(id_ev_g)
{
	$.post("../ajax/gestionaseg.php?op=mostrar",{id_ev_g : id_ev_g}, function(data, status)
	{
		data = JSON.parse(data);		
		mostrarform(true);
        ...
        $.post("../ajax/gestionaseg.php?op=verpreg",{id_preg_ev : id_preg_ev}, function(r){ //parametro r son las opciones que devuelve el id
            r = JSON.parse(r);
