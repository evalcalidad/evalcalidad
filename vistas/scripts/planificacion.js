...
function init(){
	...
	$.post("../ajax/planificacion.php?op=selecttema", function(r){ //parametro r son las opciones que devuelve el id
     $("#id_dato").html(r);
...
function reporte(){
    ...
    $url = '../reportes/rptplani.php?id=' + id_dato;
    target = "_blank";
...
function datos(){
	...
	$.post("../ajax/planificacion.php?op=datos",{id_dato : id_dato}, function(r){ //parametro r son las opciones que devuelve el id
		r = JSON.parse(r);
...
function mostrar(id_ev_p)
{
	$.post("../ajax/planificacion.php?op=mostrar",{id_ev_p : id_ev_p}, function(data, status)
	{
		data = JSON.parse(data);		
		mostrarform(true);
        ...
        $.post("../ajax/planificacion.php?op=verpreg",{id_preg_ev : id_preg_ev}, function(r){ //parametro r son las opciones que devuelve el id
            r = JSON.parse(r);
