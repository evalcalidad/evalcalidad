            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <center><h1 class="box-title">GESTIÓN DEL ASEGURAMIENTO </h1></center>
                    ...
                    <label><b><font size="2">Indicador: Gestión del aseguramiento interno de la calidad</font></b></label><br>
                    <label  align="justify"><i><font size="2" name="indicador" id="indicador">
                      ...
                      <div class="form-group col-lg-2 col-md-4 col-sm-4 col-xs-4">
                        <label>Valor de indicador: Gestión del aseguramiento</label>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-2">
                          ...
                          <label id="preg" name="preg" align="justify"></label> 
                            <input type="hidden" name="id_ev_g" id="id_ev_g">
...
<script type="text/javascript" src="scripts/gestionaseg.js"></script>
<?php 
}
ob_end_flush();
?>